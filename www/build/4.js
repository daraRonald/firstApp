...
var steelsink1DetailPage = (function () {
    ...
    steelsink1DetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page- steelsink1Detail',template:/*ion-inline-start:"/home/poeeiphyu/Desktop/MyLifeCH-Ver3/Maxten/Maxten/src/pages/list/steelsink/steelsink1Detail/steelsink1Detail.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle >\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Steel Sink Detail</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n	<ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content\n\n      pullingIcon="arrow-dropdown"\n\n      pullingText="Pull to refresh"\n\n      refreshingSpinner="circles"\n\n      refreshingText="Refreshing...">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n	<span>\n\n	 <span >\n\n	 \n\n	   <ion-card >\n\n		 <ion-slides autoplay="4000" >	\n\n		  <ion-slide *ngFor="let img of posts.images" slidesPerView="1.5" >\n\n		   <img [src]="img.src">\n\n		  </ion-slide >\n\n	     </ion-slides>\n\n		 <span class="marcol"  style="margin:10px 10px 10px 10px;width:100%;text-align:center;font-weight:bold;">\n\n		  <ion-list >\n\n		   {{posts.name}}<br>\n\n		 <span [innerHtml]="posts.short_description"></span>\n\n		  </ion-list> \n\n	     </span>	    \n\n	   </ion-card>\n\n	  \n\n	 </span> \n\n	</span>\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"/home/poeeiphyu/Desktop/MyLifeCH-Ver3/Maxten/Maxten/src/pages/list/steelsink/steelsink1Detail/steelsink1Detail.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]])
