...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wallmounted1DetailPageModule", function() { return wallmounted1DetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wallmounted1Detail__ = __webpack_require__(718);
...
var wallmounted1DetailPageModule = (function () {
    function wallmounted1DetailPageModule() {
    }
    wallmounted1DetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_0__wallmounted1Detail__["a" /* wallmounted1DetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__wallmounted1Detail__["a" /* wallmounted1DetailPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_0__wallmounted1Detail__["a" /* wallmounted1DetailPage */]
            ]
        })
    ], wallmounted1DetailPageModule);
    return wallmounted1DetailPageModule;
}());

//# sourceMappingURL=wallmounted1Detail.module.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return WallMountedPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(148);
...
var k1;
var WallMountedPage = (function () {
    function WallMountedPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.polomaxs = __WEBPACK_IMPORTED_MODULE_4__list__["l" /* wallmounted */];
    }
    WallMountedPage.prototype.cardTapped = function (event, kk) {
        this.navCtrl.push('wallmounted1DetailPage');
        k1 = kk;
    };
    WallMountedPage.prototype.doRefresh = function (refresher) {
    ...
    ], WallMountedPage.prototype, "slider", void 0);
    WallMountedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-wallmounted',template:/*ion-inline-start:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/wallmounted/wallmounted.html"*/'<ion-header>\n  <ion-navbar color="light">\n    <button ion-button menuToggle >\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>WallMounted</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="marcol">\n	<ion-refresher (ionRefresh)="doRefresh($event)">\n    <ion-refresher-content\n      pullingIcon="arrow-dropdown"\n      pullingText="Pull to refresh"\n      refreshingSpinner="circles"\n      refreshingText="Refreshing...">\n    </ion-refresher-content>\n  </ion-refresher>\n	<ion-row>\n		<ion-col *ngFor="let poloMax of polomaxs;let k=index;" col-6 >\n			 <ion-col class="marcol"  >\n						<ion-card *ngFor="let client of poloMax.categories;let i=index;" class="text-center slider-item"	style="color:blue;">\n							<span *ngIf="i==0">\n							 <span *ngFor="let img of poloMax.images;let j=index;" >\n								 <ion-card *ngIf="j==0" class="img-width">\n									   <img [src]="img.src" />\n							     </ion-card>\n							  </span>\n									<div style="text-align:center;width:100%;margin:10px 10px 10px 2px;color:black;">   {{poloMax.name}}<br>\n									   <button ion-button style="text-align:center" color="dark" small style="box-shadow:5px 5px 2px grey"  (click)="cardTapped($event,k)">~ Details ~\n							  </button></div>\n							 </span> \n					</ion-card>	\n				</ion-col>	\n			</ion-col>\n	 </ion-row>\n	\n</ion-content>\n'/*ion-inline-end:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/wallmounted/wallmounted.html"*/
        }),
    ...
    return WallMountedPage;
}());

//# sourceMappingURL=wallmounted.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return wallmounted1DetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__list__ = __webpack_require__(700);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__wallmounted__ = __webpack_require__(708);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var page = new __WEBPACK_IMPORTED_MODULE_4__list__["a" /* ListPage */](__WEBPACK_IMPORTED_MODULE_4__list__["d" /* h1 */], __WEBPACK_IMPORTED_MODULE_4__list__["e" /* h2 */], __WEBPACK_IMPORTED_MODULE_4__list__["f" /* h3 */]);
var wallmounted1DetailPage = (function () {
    function wallmounted1DetailPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.posts = __WEBPACK_IMPORTED_MODULE_4__list__["l" /* wallmounted */][__WEBPACK_IMPORTED_MODULE_5__wallmounted__["b" /* k1 */]];
    }
    wallmounted1DetailPage.prototype.doRefresh = function (refresher) {
        console.log('Begin async operation', refresher);
        setTimeout(function () {
            page.refresh(refresher);
            console.log('Async operation has ended');
    ...
    wallmounted1DetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-wallmounted1Detail',template:/*ion-inline-start:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/wallmounted/wallmounted1Detail/wallmounted1Detail.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle >\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>WallMounted Detail</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n	<ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content\n\n      pullingIcon="arrow-dropdown"\n\n      pullingText="Pull to refresh"\n\n      refreshingSpinner="circles"\n\n      refreshingText="Refreshing...">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n	<span>\n\n	 <span>\n\n	   <ion-card >\n\n		 <ion-slides autoplay="4000" >	\n\n		  <ion-slide *ngFor="let img of posts.images" slidesPerView="1.5" >\n\n		   <img [src]="img.src">\n\n		  </ion-slide >\n\n	     </ion-slides>\n\n		 <span class="marcol"  style="margin:10px 10px 10px 10px;width:100%;text-align:center;font-weight:bold;">\n\n		  <ion-list >\n\n		   {{posts.name}}<br>\n\n		 <span [innerHtml]="posts.short_description"></span>\n\n		  </ion-list> \n\n	     </span>	    \n\n	   </ion-card>\n\n	  \n\n	 </span> \n\n	</span>\n\n</ion-content>\n\n'/*ion-inline-end:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/wallmounted/wallmounted1Detail/wallmounted1Detail.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]])
    ], wallmounted1DetailPage);
    return wallmounted1DetailPage;
}());

//# sourceMappingURL=wallmounted1Detail.js.map
