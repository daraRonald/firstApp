...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bathroom1DetailPageModule", function() { return bathroom1DetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bathroom1Detail__ = __webpack_require__(711);
...
var bathroom1DetailPageModule = (function () {
    function bathroom1DetailPageModule() {
    }
    bathroom1DetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_0__bathroom1Detail__["a" /* bathroom1DetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__bathroom1Detail__["a" /* bathroom1DetailPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_0__bathroom1Detail__["a" /* bathroom1DetailPage */]
            ]
        })
    ], bathroom1DetailPageModule);
    return bathroom1DetailPageModule;
}());

//# sourceMappingURL=bathroom1Detail.module.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BathroomPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(148);
...
var k1;
var BathroomPage = (function () {
    function BathroomPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.polomaxs = __WEBPACK_IMPORTED_MODULE_4__list__["b" /* bathroom */];
    }
    BathroomPage.prototype.cardTapped = function (event, kk) {
        this.navCtrl.push('bathroom1DetailPage');
        k1 = kk;
    };
    BathroomPage.prototype.doRefresh = function (refresher) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return bathroom1DetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__list__ = __webpack_require__(700);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__bathroom__ = __webpack_require__(701);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var page = new __WEBPACK_IMPORTED_MODULE_4__list__["a" /* ListPage */](__WEBPACK_IMPORTED_MODULE_4__list__["d" /* h1 */], __WEBPACK_IMPORTED_MODULE_4__list__["e" /* h2 */], __WEBPACK_IMPORTED_MODULE_4__list__["f" /* h3 */]);
var bathroom1DetailPage = (function () {
    function bathroom1DetailPage(navCtrl, http) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.posts = __WEBPACK_IMPORTED_MODULE_4__list__["b" /* bathroom */][__WEBPACK_IMPORTED_MODULE_5__bathroom__["b" /* k1 */]];
    }
    bathroom1DetailPage.prototype.doRefresh = function (refresher) {
        console.log('Begin async operation', refresher);
        setTimeout(function () {
            page.refresh(refresher);
            console.log('Async operation has ended');
    ...
    bathroom1DetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-bathroom1Detail',template:/*ion-inline-start:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/bathroom/bathroom1Detail/bathroom1Detail.html"*/'<ion-header>\n\n  <ion-navbar color="light">\n\n    <button ion-button menuToggle >\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Bathroom Detail</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n	<ion-refresher (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content\n\n      pullingIcon="arrow-dropdown"\n\n      pullingText="Pull to refresh"\n\n      refreshingSpinner="circles"\n\n      refreshingText="Refreshing...">\n\n    </ion-refresher-content>\n\n  </ion-refresher>\n\n	<span>\n\n	 <span >\n\n	 \n\n	   <ion-card >\n\n		 <ion-slides autoplay="4000" >	\n\n		  <ion-slide *ngFor="let img of posts.images" slidesPerView="1.5" >\n\n		   <img [src]="img.src">\n\n		  </ion-slide >\n\n	     </ion-slides>\n\n		 <span class="marcol"  style="margin:10px 10px 10px 10px;width:100%;text-align:center;font-weight:bold;">\n\n		  <ion-list >\n\n		   {{posts.name}}<br>\n\n		 <span [innerHtml]="posts.short_description"></span>\n\n		  </ion-list> \n\n	     </span>	    \n\n	   </ion-card>\n\n	  \n\n	 </span> \n\n	</span>\n\n</ion-content>\n\n'/*ion-inline-end:"/home/poeeiphyu/Desktop/MyLifeCH/Maxten/Maxten/src/pages/list/bathroom/bathroom1Detail/bathroom1Detail.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* Http */]])
    ], bathroom1DetailPage);
    return bathroom1DetailPage;
}());

//# sourceMappingURL=bathroom1Detail.js.map
